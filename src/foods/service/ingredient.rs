...
use crate::foods::models::ingredient::IngredientCursor;
use crate::foods::models::ingredient::{
    BatchIngredientSortInput, IngredientCreateInput, IngredientOut, IngredientRecord,
...
impl IngredientService {
    pub async fn list_ingredients(
        ...
        let mut rows = qb
            .build_query_as::<IngredientRecord>()
            .fetch_all(db)
            .await?;
    ...
    pub async fn update_ingredients_sort(
        ...
        let mut qb = sqlx::QueryBuilder::<sqlx::Postgres>::new(
            "UPDATE ingredients SET sort = CASE ingredient_id ",
        );
        let mut ids = Vec::new();
