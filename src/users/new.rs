...
pub async fn register(
    ...
    sqlx
        ::query(
            r#"INSERT INTO users (
                username, password_hash, password_algo, gender, birthday, phone_verified, login_method, role, love_point, status, is_temp_password
            ) VALUES (
                $1, $2, $3, $4, NULL, FALSE, $5, $6, 0, 1, FALSE
            )"#
        )
        .bind(&data.username)
        .bind(&pwd_hash)
